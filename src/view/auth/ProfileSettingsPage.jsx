...
export default function ProfileSettingsPage() {
  ...
  <div className="flex gap-10 w-full max-w-5xl">
    ...
    <form
      className="p-10 bg-nav-gray w-1/2 rounded-box shadow-lg"
    ...
    >
      ...
      <button className="btn btn-neutral p-5 w-full">Edit</button>
    </form>

    <form
      className="p-10 bg-nav-gray w-1/2 rounded-box shadow-lg flex flex-col justify-between"
  ...
  {preview && (
    <img
      src={preview}
      alt=""
      className="w-50 h-40 object-cover rounded-full border"
    />
  )}
